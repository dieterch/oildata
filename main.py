...
try:
    ...
    def select_file():
        ...
        try:
            ...
            raise
    open_button = tk.Button(root, text='Spectro CSV File einlesen', command=select_file, height=bh, width=bw)
    ...
    unique_button = tk.Button(root, text="Zusammenfassung, wähle Excel file", command=summary_select_file, height=bh, width=bw)
    unique_button.pack(side = tk.TOP, padx = _px, pady = _py+3)
    #*************************************
    ...
    quit_button.pack(side = tk.TOP, padx = _px, pady = _py-7)
    #*************************************
